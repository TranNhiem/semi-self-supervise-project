...
'''
Layer-Wise adaptive Rate scale for Large Batch_size Training 

Introduced by "Large Batch Training of Convolutional Networks" by Y. You,
  I. Gitman, and B. Ginsburg. (https://arxiv.org/abs/1708.03888)


Implementation Reference from SimCLRV2 
...
class LARS_optimzer(tf.keras.optimizers.Optimizer):
    ...
    Args: 
        ...
        exclude_from_weight_decay: A list of `string` for variable screening, if
            ...
            excluded for computing weight decay.
    ...
    def __init__(self, learning_rate,
        ...
        super(LARS_optimzer, self).__init__(name)
        ...
        # exclude_from_layer_adaptation is set to exclude_from_weight_decay if the arg is None.
    ...
    def get_config(self):
        config = super(LARS_optimzer, self).get_config()
        config.update({
